  ...
  private loadFromStorage() {
    try {
      ...
      if (notificationsData) {
        this.notifications = JSON.parse(notificationsData).map(
          (notification: any) => ({
            ...notification,
  ...
  private async sendBrowserNotification(alert: Alert) {
    if ("Notification" in window && Notification.permission === "granted") {
      new Notification(`Liirat News Alert: ${alert.title}`, {
        ...
        badge:
          "https://cdn.builder.io/api/v1/image/assets%2F8d6e2ebe2191474fb5a6de98317d4278%2Fae40207ed1d14041b2dc30fdddcc0531?format=webp&width=800",
      });
    }
  }
